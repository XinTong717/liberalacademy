...
export default function Home() {
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-[#fbf7ee]">
      ...
      {/* Navigation overlay */}
      <div className="absolute top-6 right-6 z-10 flex flex-wrap gap-3">
        <Link
          href="/login"
      ...
      {/* Title overlay */}
      <div className="absolute top-6 left-6 z-10 flex items-center gap-4 rounded-2xl border border-[#efdcc4] bg-white/85 px-4 py-3 shadow-lg backdrop-blur">
        <Image
        ...
        <div>
          ...
          <p className="text-sm text-[#7a9bb8]">在家教育社区地图</p>
        </div>
      </div>
    </div>
  )
